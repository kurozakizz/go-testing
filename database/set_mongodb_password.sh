...
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"pokemon"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"pokemon"}
...
mongoimport --host localhost --db $MONGODB_APPLICATION_DATABASE --collection pokemons --type json --file ./seed.json --jsonArray -u $MONGODB_APPLICATION_USER -p $MONGODB_APPLICATION_PASS
